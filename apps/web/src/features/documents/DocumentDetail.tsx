  ...
  return (
    <article className="document-canvas">
      ...
      <input
        ...
        value={title}
      />
      <p className="document-meta">Last edited {new Date(document.updatedAt).toLocaleString()}</p>
      <div className="editor-placeholder">
        <Monitor size={18} />
        <p>Editor MVP is next. This page now owns title editing and document actions.</p>
      </div>
    </article>
  );
}
