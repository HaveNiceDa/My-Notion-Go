...
8. `engineering-ui-rules.md`：shadcn/ui、Tailwind、i18n、ahooks、Trae rules、代码生成规范。
...
- M6 已开启：优先落地 PostgreSQL 版文档搜索和 Command Palette，搜索 API 形状预留后续替换 Elasticsearch 的空间。
